...
#filepath = "afjOUT.txt"
outputNKA = "afjTMPOUT.txt"
outputDKA = "AFJTMPOUT1.txt"
#filepath = "afj1.txt"
...
if __name__ == "__main__":
    ...
    with open(filepath) as fp:
        ...
        while line or na_ktorom_som_riadku <= len(subor):
            ...
            if prvy_symbol_v_riadku == 'I' and len(line) > 1:
            ...
            if prvy_symbol_v_riadku == 'C' and len(line) > 1:
                # check ci existuje riadok
                riadok = line.split(',')
                if int(riadok[1]) > len(subor.keys()):
                    print("CHYBA - Referencia na riadok, ktory neexistuje.")
            ...
            if prvy_symbol_v_riadku == 'U' and len(line) > 1:
                # check ci existuje riadok
                riadok = line.split(',')
                if int(riadok[1]) > len(subor.keys()):
                    print("CHYBA - Referencia na riadok, ktory neexistuje.")

...
if __name__ == "__main__":
    ...
    for no_of_sheet in range(0,no_of_sheet):
        ...
        for i in range(1, pocet_pomocnikov):
            if no_of_sheet == 0:
                p = pomocnik(sheet.cell_value(i, 1),sheet.cell_value(i, 2))
